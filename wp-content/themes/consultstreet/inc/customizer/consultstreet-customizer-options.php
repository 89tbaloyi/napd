...
$config_customizer = array(
    ...
    'deactivate_button_label'   => esc_html__( 'Deactivate', 'consultstreet' ),
);
ConsultStreet_Customizer_Notice::init( apply_filters( 'consultstreet_customizer_notice_array', $config_customizer ) );