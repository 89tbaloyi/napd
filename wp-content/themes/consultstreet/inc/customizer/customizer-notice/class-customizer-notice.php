<?php
/**
 * ConsultStreet Customizer Notification System.
 *
...
/**
 * ConsultStreet Customizer Notify Class
 */
class ConsultStreet_Customizer_Notice {
	...
	/**
	 * The single instance of ConsultStreet_Customizer_Notice
	 *
	 * @var ConsultStreet_Customizer_Notice $instance The ConsultStreet_Customizer_Notice instance.
	 */
	...
	/**
	 * The Main ConsultStreet_Customizer_Notice instance.
	 *
	 * We make sure that only one instance of exists in the memory at one time.
	 *
	 * @param array $config The configuration array.
	 */
	public static function init( $config ) {
		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof ConsultStreet_Customizer_Notice ) ) {
			self::$instance = new ConsultStreet_Customizer_Notice;
	...
	public function setup_config() {
		...
		global $consultstreet_recommended_plugins;
		...
		$consultstreet_recommended_plugins = array();
		
		if ( isset( $this->recommended_plugins ) ) {
			$consultstreet_recommended_plugins = $this->recommended_plugins;
		}
	...
	public function scripts_for_customizer() {
		...
		wp_enqueue_style( 'consultstreet-customizer-notice', get_template_directory_uri() . '/inc/customizer/customizer-notice/css/customizer-notice.css', array(), CONSULTSTREET_THEME_VERSION );
		...
		wp_enqueue_script( 'consultstreet-customizer-notice', get_template_directory_uri() . '/inc/customizer/customizer-notice/js/customizer-notice.js', array( 'customize-controls' ), CONSULTSTREET_THEME_VERSION );
		wp_localize_script(
			'consultstreet-customizer-notice', 'customizer_notice_data', array(
	...
	public function customize_register_notice( $wp_customize ) {
		...
		/**
		 * Include the ConsultStreet_Customizer_Notice_Section class.
		 */
		require_once get_template_directory() . '/inc/customizer/customizer-notice/class-customizer-notice-section.php';

		$wp_customize->register_section_type( 'ConsultStreet_Customizer_Notice_Section' );

		$wp_customize->add_section(
			new ConsultStreet_Customizer_Notice_Section(
				$wp_customize,
	...
	public function dismiss_recommended_plugins_callback() {
		...
		if ( ! empty( $action_id ) ) {
			...
			$show_recommended_plugins = get_option( 'consultstreet_show_recommended_plugins' );
			...
			update_option( 'consultstreet_show_recommended_plugins', $show_recommended_plugins );
		}
